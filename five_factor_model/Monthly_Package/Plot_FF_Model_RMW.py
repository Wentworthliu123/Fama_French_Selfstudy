...
Datatoread='F-F_Research_Data_5_Factors_2x3'
sdate='1982-07-01'
edate='2018-12-31'
...
infile='F:\\RA_Fama_French_Factor\\five_factor_model\\SIZE_RMW\\FF_Model_RMW8018_firm.xlsx'
...
plt.ylabel("Return")
plt.title(factor)
plt.plot(_ffcomp['date'],_ffcomp[factor],label = 'FF_'+wfactor,color='red')
plt.plot(_ffcomp['date'],_ffcomp[wfactor], label = 'Rep_'+factor,color='blue')
plt.legend(loc="best")
