...
dataout='Matching_test_{}_with_yuxingtable.csv'.format(str(startdate))
finalmatch_crsp_taq.to_csv(dataout)

descriptionout='Matching_description_{}_with_yuxingtable.csv'.format(str(startdate))
result.to_csv(descriptionout)
