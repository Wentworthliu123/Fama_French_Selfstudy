...
def portfolio(start,end, comp):
    ...
    ccm4=ccm4.drop_duplicates(subset=['date','permno'], keep='last')
    CSV_FILE_PATH="{}_{}_daily_all_RCC.csv".format(str(rangestart),str(rangeend)[4:])
    portfolio_to_save= os.path.join(portfoliopath, CSV_FILE_PATH)
    ccm4.to_csv(portfolio_to_save)

for year in range(1996, 2018):
    portfolio(year*10000+701,year*10000+10630, comp)
