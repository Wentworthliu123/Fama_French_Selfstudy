...
crsp_m = conn.raw_sql("""
                      ...
                      where a.date between '01/01/1986' and '07/31/2018'
...
vwret=ccm4.groupby(['jdate','szport','bmport']).apply(wavg, 'retadj','lme').to_frame().reset_index().rename(columns={0: 'vwret'})
...
# # output data #
# ###################
dataout='Daily_SIZE_HML_TEST9018.xlsx'
