...
##########################################
# Fama French Factors -- Daily Rm_Rf
# October 30 2019
...
# Compare With FF #
###################
#The specific content of this table and library can easily be tested using jupyter notebook
_ff = conn.get_table(library='ff', table='factors_daily')
